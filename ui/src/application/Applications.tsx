    ...
    public render() {
        ...
        return (
            <DefaultPage
                ...
                {messageId !== false && (
                    <MessageDialog
                        fClose={() => (this.messageId = false)}
                        fOnSubmit={appStore.createmessage}
                    />
                )}
...
const Row: SFC<IRowProps> = observer(
    ({name, value, noDelete, description, fDelete, fUpload, image, fEdit}) => (
        <TableRow>
            ...
            {/* <TableCell align="right" padding="none">
                <IconButton onClick={fMessage} className="edit">
                    <Edit />
                </IconButton>
            </TableCell> */}
        </TableRow>
